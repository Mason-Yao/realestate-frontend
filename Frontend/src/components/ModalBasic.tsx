...
function ModalBasic({ children, id, title, modalOpen, setModalOpen, size }) {
  ...
  return (
    <>
      ...
      <Transition
        ...
        appear={undefined}
      >
        <div ref={modalContent} className={`bg-white rounded shadow-lg overflow-auto w-full max-h-full ${size}`}>
          {/* Modal header */}
