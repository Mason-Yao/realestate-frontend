  ...
  return (
    <div {...rest}>
      ...
      <Transition
        show={dropdownOpen}
        tag="div"
        className={`origin-top-right z-10 absolute min-w-36 bg-white border border-slate-200 py-1.5 rounded shadow-lg overflow-hidden mt-1 
          ${align === "right" ? "right-0" : "left-0"} 
          ${rest.index === rest.size - 1 ? "bottom-full" : "top-full"}`}
