...
import { convertAutoCompleteAddressToAddress, numberToPrice, priceToNumber } from "../../../utils/helper"
import { POI } from "../../../../../Shared/Interface/property"
import { addProperty } from "../../../apis/property"
    ...
    <>
      <div className="flex flex-col gap-4 w-full px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex justify-center">
          <button type="submit" className="btn bg-indigo-500 hover:bg-indigo-600 text-white" onClick={() => onSubmit()}>
            Submit
          </button>
        </div>
      </div>
